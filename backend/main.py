...
# Explicit origins from env — wildcards must NOT be in this list
# (use CORS_ORIGIN_REGEX for pattern-matched origins such as Vercel preview URLs)
allowed_origins = [
    origin.strip()
...
app.add_middleware(
    ...
    # Regex handles wildcard patterns — covers all *.vercel.app preview URLs
